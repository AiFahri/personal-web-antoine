    ...
    <div className="flex flex-col space-y-8 md:w-[500px]">
        ...
        onSubmit={async (values, { resetForm }) => {
          ...
          try {
            ...
            if (datas.status >= 400) {
              ...
              setMessage("Error joining the newsletter. Please try again later.");
              setTimeout(() => {
                setMessage("");
      ...
      >
        <Form className="w-full">
          <div className="w-full bg-black text-white font-[SpaceGroteskRegular] border flex-1 border-white rounded-full flex gap-2 px-3">
            ...
            <button className="rounded-full bg-[#E1462B]  my-2 px-4 py-2 font-bold text-white transition-all hover:scale-105 disabled:opacity-80" type="submit" disabled={buttonDisabled}>
